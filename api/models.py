...
class Host(models.Model):
    ...
    groups = models.ManyToManyField('HostGroup', blank=True)  # A B C
...
class Template(models.Model):
    name = models.CharField(max_length=64, unique=True, verbose_name=u'模版名称')
...
class Service(models.Model):
    name = models.CharField(max_length=64, unique=True, verbose_name=u'服务列表')
    interval = models.IntegerField(default=60, verbose_name=u'监控间隔')
    plugin_name = models.CharField(u'插件名', max_length=64, default='n/a', help_text=u'对应 agent 里的插件名')
